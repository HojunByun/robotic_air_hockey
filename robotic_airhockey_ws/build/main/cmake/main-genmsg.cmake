...
set(MSG_I_FLAGS "-Imain:/home/alvin/robotic_airhockey_ws/src/main/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/alvin/robotic_airhockey_ws/src/main/msg/ArmAngles.msg" NAME_WE)
add_custom_target(_main_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "main" "/home/alvin/robotic_airhockey_ws/src/main/msg/ArmAngles.msg" ""
)
...
_generate_msg_cpp(main
  "/home/alvin/robotic_airhockey_ws/src/main/msg/ArmAngles.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/main)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/main\")")
  # install generated code
  install(
