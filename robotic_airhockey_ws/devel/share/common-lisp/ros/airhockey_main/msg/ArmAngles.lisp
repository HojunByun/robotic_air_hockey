...
(cl:in-package airhockey_main-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ArmAngles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmAngles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airhockey_main-msg:<ArmAngles> is deprecated: use airhockey_main-msg:ArmAngles instead.")))

(cl:ensure-generic-function 'arm0_joint0-val :lambda-list '(m))
(cl:defmethod arm0_joint0-val ((m <ArmAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airhockey_main-msg:arm0_joint0-val is deprecated.  Use airhockey_main-msg:arm0_joint0 instead.")
  (arm0_joint0 m))

(cl:ensure-generic-function 'arm0_joint1-val :lambda-list '(m))
(cl:defmethod arm0_joint1-val ((m <ArmAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airhockey_main-msg:arm0_joint1-val is deprecated.  Use airhockey_main-msg:arm0_joint1 instead.")
  (arm0_joint1 m))

(cl:ensure-generic-function 'arm1_joint0-val :lambda-list '(m))
(cl:defmethod arm1_joint0-val ((m <ArmAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airhockey_main-msg:arm1_joint0-val is deprecated.  Use airhockey_main-msg:arm1_joint0 instead.")
  (arm1_joint0 m))

(cl:ensure-generic-function 'arm1_joint1-val :lambda-list '(m))
(cl:defmethod arm1_joint1-val ((m <ArmAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airhockey_main-msg:arm1_joint1-val is deprecated.  Use airhockey_main-msg:arm1_joint1 instead.")
  (arm1_joint1 m))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ArmAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airhockey_main-msg:success-val is deprecated.  Use airhockey_main-msg:success instead.")
  (success m))
